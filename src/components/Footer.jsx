...
function Footer() {
  return (
    <footer className=''>
    <div className="bg-gray-800 py-4 text-gray-400" id='footer'>
      <div className="container px-4 mx-auto">
        <div className="-mx-4 flex flex-wrap justify-between">
          ...
          <div className="px-4 my-4 w-full sm:w-auto">
            <div>
              <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-primary-600">Company</h2>
            </div>
          ...
          <div className="px-4 my-4 w-full sm:w-auto">
            <div>
              <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-primary-600">Blog</h2>
            </div>
            <ul className="leading-8">
          ...
          <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5">
            <div>
              <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-primary-600">Connect With Us</h2>
            </div>
    ...
    <div className="bg-primary-700 py-4 text-gray-100">
      <div className="container mx-auto px-4">
        <div className="-mx-4 flex flex-wrap justify-between">
          <div className="px-4 w-full text-center sm:w-auto sm:text-left">
            Copyright © 2020 - 
            {new Date().getFullYear()}
            {' '} SnapCartify. All Rights Reserved.
          </div>
          <div className="px-4 w-full text-center sm:w-auto sm:text-left">
            Made with ❤️ by SnapCartify.
          </div>
        </div>
      </div>
    </div>
